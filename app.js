...
app.post("/api/v1/people", (req, res) => {
  ...
  res.status(201).json({ message: "New user added", index: req.body.index });
});
...
/// First implement the routes for the adding a new people entry, getting the list of people entered and
/// getting a single user. People entries are stored in the people array which starts as an empty array.
/// We are not working with a database.
